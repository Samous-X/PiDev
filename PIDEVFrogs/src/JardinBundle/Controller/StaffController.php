...
class StaffController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $staff = $em->getRepository('JardinBundle:Staff')->findAll();

        return $this->render('@Jardin/staff/index.html.twig', array(
            'staff' => $staff,
        ));
    }
    ...
    public function disableAction($id)
    {
        ...
        $staff = $em->getRepository('JardinBundle:Staff')->find($id);
    ...
    {
        $staff = new Staff();
        $form = $this->createForm('JardinBundle\Form\StaffType', $staff);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render('@Jardin/staff/new.html.twig', array(
                'staff' => $staff,
    ...
    public function showAction(Staff $staff)
    {
        ...
        return $this->render('@Jardin/staff/show.html.twig', array(
            'staff' => $staff,
    ...
    {
        $deleteForm = $this->createDeleteForm($staff);
        $editForm = $this->createForm('JardinBundle\Form\StaffType', $staff);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->render('@Jardin/staff/edit.html.twig', array( 'edit_form' => $editForm->createView(),"msg"=>"Modfié avec succés",'id' => $staff->getId()));
        }else if($editForm->isSubmitted() &&!$editForm->isValid()){
            return $this->render('@Jardin/staff/edit.html.twig', array('edit_form' => $editForm->createView(),"error"=>"Les champs sont invalides",'id' => $staff->getId()));
        }

        return $this->render('@Jardin/staff/edit.html.twig', array(
            'staff' => $staff,
