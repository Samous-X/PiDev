...
use JardinBundle\Entity\Rating;
...
class RatingController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $ratings = $em->getRepository('JardinBundle:Rating')->findAll();
        ...
        $rating = new Rating();
        $form = $this->createForm('JardinBundle\Form\RatingType', $rating)->add('rating',\blackknight467\StarRatingBundle\Form\RatingType::class, [
            //...
            'label' => "Rating",
            //...
        ]);
        ...
        return $this->render('@Jardin/rating/index.html.twig', array(
            'ratings' => $ratings,
            "count"=>count($ratings),
    ...
    public function ratinglistAction(Request $request)
    {
        ...
        return $this->render('@Jardin/rating/indexadmin.html.twig', array(
            'ratings' => $ratings,
            "count"=>count($ratings),
            "average"=>$average,
        ));
    ...
    {
        $deleteForm = $this->createDeleteForm($rating);
        $editForm = $this->createForm('JardinBundle\Form\RatingType', $rating);
