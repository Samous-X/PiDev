...
use JardinBundle\Entity\Panier;
use JardinBundle\Entity\Panier_element;
use JardinBundle\PanierBundle;
...
class PanierController extends Controller
{
    ...
    {
        $panier = $this->getDoctrine()->getRepository('JardinBundle:Panier')->findBy(array(),array('date'=>"DESC"));
    ...
    public function detailAction($id){
        ...
        $panier = $this->getDoctrine()->getRepository('JardinBundle:Panier')->find($id);

        $elements = $this->getDoctrine()->getRepository('JardinBundle:Panier_element')->findByPanier($panier);
    ...
    public function deleteCommandeAction($id){
        ...
        $commande= $em->getRepository('JardinBundle:Panier')->find($id);
        $em->remove($commande);
        $em->flush();
