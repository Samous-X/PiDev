...
use DateTime;
use JardinBundle\Entity\Equipement;
...
class EquipementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $equipements = $em->getRepository('JardinBundle:Equipement')->findAll();

        return $this->render('@Jardin/equipement/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('JardinBundle\Form\EquipementType', $equipement);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render('@Jardin/equipement/new.html.twig', array(
    ...
    public function showAction(Equipement $equipement)
    {
        ...
        return $this->render('@Jardin/equipement/show.html.twig', array(
            'equipement' => $equipement,
    ...
    {
        $deleteForm = $this->createDeleteForm($equipement);
        $editForm = $this->createForm('JardinBundle\Form\EquipementType', $equipement);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->render('@Jardin/equipement/edit.html.twig', array("msg"=>"Modfié avec succés",'equipement' => $equipement,'edit_form' => $editForm->createView()));
        }else if($editForm->isSubmitted() &&!$editForm->isValid()){
            return $this->render('@Jardin/equipement/edit.html.twig', array("error"=>"Les champs sont invalides",'equipement' => $equipement,'edit_form' => $editForm->createView()));
        }

        return $this->render('@Jardin/equipement/edit.html.twig', array(
            'equipement' => $equipement,
