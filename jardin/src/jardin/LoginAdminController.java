...
public class LoginAdminController implements Initializable {
     ...
     */
    private Directeur loggedUtilisateur;
    private static LoginAdminController instance;
    public static final Map<Integer, Directeur> UTILISATEUR = new HashMap<>(); 
    ...
    public Directeur getLoggedUtilisateur() {
            ...
            if (myServices.chercherUtilisateurBylogin(username) && pas==true)
            {
                if (myServices.Gettype(username).equals("admin"))
                {
                    ...
                    pauseTransition.setOnFinished(ev -> 
                    {
                        ...
                        loggedUtilisateur = Directeur.of(userConnecter.getId_utilisateur());
