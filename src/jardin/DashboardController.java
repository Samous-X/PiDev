...
public class DashboardController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TableColumn<Utilisateur, Integer> TcTel;
    @FXML
    private TableColumn<Utilisateur,String> TcLogin;
    @FXML
    private TableColumn<Utilisateur, String> TcPassword;
    @FXML
    private TableView<Utilisateur> membres;
    
    private List<Utilisateur> listParent;//retourner liste de la select
    private ObservableList<Utilisateur> ObservablelisteParent;//pour la table view
    @FXML
    private TextField tfId;
    @FXML
    private TextField tfNom;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Utilisateur loggedUtilisateur = LoginAdminController.getInstance().getLoggedUtilisateur();
        Utilisateur UtilisateurConnecte = myServices.chercherUtilisateurByid(loggedUtilisateur.getId_utilisateur());
   ...
   /* private void modifierparent(ActionEvent event) throws IOException, SQLException {
    ...
    private void supprimerparent(ActionEvent event) throws SQLException {
        ...
        Utilisateur utilisateur = membres.getSelectionModel().getSelectedItem();
